...
//오선지이미지다
public class Fiveline implements GraphicObject {
	Jmbar jmbar=new Jmbar(this);
	File f1 = new File(Fiveline.class.getResource("../Top_Image/FiveLinePaper1.jpg").getFile());// 앞 5선지
	File f2 = new File(Fiveline.class.getResource("../Top_Image/FiveLinePaper2.jpg").getFile());// 뒤 5선지
